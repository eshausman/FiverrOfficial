...
class AiAnimationScreen extends StatelessWidget {
  const AiAnimationScreen({super.key});
        ...
        child: Container(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
              Text('AI Animation', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold,),),
              SizedBox(height: 15,),
              Text('Create cool, amazing logos for video intro & animation videos,... and help bring your bussiness to life'),
              SizedBox(height: 20,),
              Row(children: [
                Container(width: 80,
                height: 45,
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                        Text('Create glorious logo anima-', style: TextStyle(fontSize: 15),),
                        Text('tion or youtube ...', style: TextStyle(fontSize: 15))
                        ],),
                      ),
                      Spacer(),
                      Row(
                        children: [
                          SizedBox(width: 160,),
                        Text('From:'),Text(' \$10', style: TextStyle(fontSize: 20),),
                        SizedBox(width: 10,)
                      ],),
                      SizedBox(height: 10,)
                    ],
